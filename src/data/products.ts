...
export const BRANDS: Record<string, Brand> = {
  ...
  ep: {
    ...
    name: 'EP Equipment',
    slug: 'ep-forklifts',
    description: 'EP Equipment is a global manufacturer of material handling solutions, specializing in lithium-ion powered forklifts, pallet trucks, stackers, and warehouse equipment for modern logistics and industrial operations.',
    country: 'China',
  ...
  airpipe: {
    ...
    name: 'AIRpipe',
    slug: 'airpipe',
    description: 'Instamod AIRpipe — Manufacturer of compressed air aluminum, stainless steel, and zinc nickel piping systems with quick-connect technology for efficient air distribution.',
    country: 'India',
...
export const PRODUCT_CATEGORIES: ProductCategoryInfo[] = [
  ...
  },
  {
    ...
    description: 'Aluminium, stainless steel, and zinc nickel piping systems for compressed air distribution.',
    icon: 'GitBranch',
...
export const PRODUCTS: Product[] = [
  ...
  // ── EP Equipment Products ───────────────
  {
    id: 'ep-electric-forklifts',
    name: 'Electric Forklifts',
    brand: BRANDS.ep,
    category: 'material-handling',
    slug: 'ep-electric-forklifts',
    description: 'EP Equipment lithium-ion powered electric forklifts designed for clean, efficient indoor and outdoor material handling operations with low maintenance and zero emissions.',
    shortDescription: 'Lithium-ion electric forklifts for clean, efficient material handling operations.',
    images: [],
    specifications: [
      { label: 'Type', value: 'Lithium-Ion Electric' },
    ...
    relatedProducts: ['ep-diesel-forklifts', 'ep-warehouse-equipment'],
  },
  {
    id: 'ep-diesel-forklifts',
    name: 'Diesel Forklifts',
    brand: BRANDS.ep,
    category: 'material-handling',
    slug: 'ep-diesel-forklifts',
    description: 'Heavy-duty EP Equipment diesel forklifts for demanding industrial applications requiring robust performance and high lifting capacity.',
    shortDescription: 'Heavy-duty diesel forklifts for demanding industrial applications.',
    images: [],
    specifications: [
    ...
    relatedProducts: ['ep-electric-forklifts', 'ep-warehouse-equipment'],
  },
  {
    id: 'ep-warehouse-equipment',
    name: 'Warehouse Equipment',
    brand: BRANDS.ep,
    category: 'material-handling',
    slug: 'ep-warehouse-equipment',
    description: 'EP Equipment range of electric pallet trucks, stackers, and specialized warehouse equipment for efficient logistics and warehousing operations.',
    shortDescription: 'Electric pallet trucks, stackers, and warehouse equipment for efficient logistics.',
    images: [],
    specifications: [
      { label: 'Type', value: 'Electric Warehouse Equipment' },
      { label: 'Power', value: 'Lithium-Ion Battery' },
    ],
    applications: ['Warehousing', 'Distribution centers', 'Retail logistics', 'Manufacturing'],
    features: ['Compact and maneuverable', 'Lithium-ion powered', 'Low maintenance', 'Ergonomic design'],
    relatedProducts: ['ep-electric-forklifts', 'ep-diesel-forklifts'],
  },

  // ── AIRpipe Products ────────────────────
  {
    id: 'airpipe-aluminium-piping',
    name: 'Aluminium Piping System',
    brand: BRANDS.airpipe,
    category: 'compressed-air-piping',
    slug: 'airpipe-aluminium-piping',
    description: 'AIRpipe aluminium compressed air piping system with quick-connect technology. Lightweight, corrosion-resistant, and designed for fast installation compared to traditional piping.',
    shortDescription: 'Quick-connect aluminium piping for fast and reliable compressed air distribution.',
    images: [],
    specifications: [
      { label: 'Material', value: 'Aluminium' },
      { label: 'Connection', value: 'Quick-Connect' },
      { label: 'Corrosion', value: 'Corrosion-Resistant' },
    ],
    applications: ['Compressed air distribution', 'Vacuum systems', 'Inert gas applications'],
    features: [
      'Quick-connect technology — no threading, soldering, or gluing',
      'Fast installation compared to traditional piping',
      'Lightweight and easy to handle',
      'Highly resistant to corrosion',
      'Smooth internal bore — minimal pressure drops',
      'Modular and expandable',
    ],
    relatedProducts: ['airpipe-stainless-piping', 'airpipe-fittings'],
  },
  {
    id: 'airpipe-stainless-piping',
    name: 'Stainless Steel Piping System',
    brand: BRANDS.airpipe,
    category: 'compressed-air-piping',
    slug: 'airpipe-stainless-piping',
    description: 'AIRpipe stainless steel piping for demanding environments requiring high purity, washdown capability, or resistance to harsh chemicals.',
    ...
    relatedProducts: ['airpipe-aluminium-piping', 'airpipe-fittings'],
  },
  {
    id: 'airpipe-fittings',
    name: 'AIRpipe Fittings & Accessories',
    brand: BRANDS.airpipe,
    category: 'compressed-air-piping',
    slug: 'airpipe-fittings',
    description: 'Complete range of AIRpipe fittings and accessories for building and expanding compressed air piping networks.',
    shortDescription: 'Complete range of quick-connect fittings and piping accessories.',
    images: [],
    specifications: [],
    applications: ['All compressed air piping installations'],
    features: [
      'Compatible with AIRpipe aluminium and stainless systems',
